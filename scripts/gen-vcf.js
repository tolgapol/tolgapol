...
const LANGS = {
  en: {
    ...
    country: 'Türkiye',
    note: "Head of Digital Marketing at incehesap.com — Türkiye's tech e-commerce marketplace. Builds performance-driven growth across SEO, paid media, CRM automation, analytics, and conversion optimisation.",
  },
  tr: {
  ...
  es: {
    ...
    country: 'Türkiye',
    note: "Director de Marketing Digital en incehesap.com — el marketplace e-commerce tech de Türkiye. Construye crecimiento en SEO, medios de pago, automatización CRM, analítica y optimización de conversión.",
  },
  de: {
    ...
    country: 'Türkiye',
    note: "Leiter Digitales Marketing bei incehesap.com — Türkiyes Tech-E-Commerce-Marktplatz. Baut leistungsgetriebenes Wachstum in SEO, bezahlten Medien, CRM-Automatisierung, Analytics und Conversion-Optimierung auf.",
  },
  fr: {
    ...
    country: 'Türkiye',
    note: "Directeur du Marketing Digital chez incehesap.com — le marketplace e-commerce tech de Türkiye. Construit une croissance basée sur la performance dans le SEO, les médias payants, l'automatisation CRM et l'optimisation de conversion.",
  },
  'zh-TW': {
